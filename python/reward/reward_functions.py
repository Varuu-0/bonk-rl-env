...
class NavigationReward(BaseRewardFunction):
    ...
    def __init__(
        ...
        super().__init__(name="NavigationReward", reward_clip=reward_clip, enabled=enabled)
...
class CompositeReward(BaseRewardFunction):
    ...
    def __init__(
        ...
        super().__init__(name="CompositeReward", reward_clip=reward_clip, enabled=enabled)
...
class CuriosityReward(BaseRewardFunction):
    ...
    def __init__(
        ...
        super().__init__(name="CuriosityReward", reward_clip=reward_clip, enabled=enabled)
    ...
    def _compute_intrinsic_curiosity(
        ...
        prev_states = np.array(self._state_buffer[-100:])[:-1]
        ...
        # A revisited state has zero novelty; farther states receive a larger
        # bounded exploration signal without rewarding exact repeats.
        novelty = min_distance / (1.0 + min_distance)
...
class CountBasedExplorationReward(BaseRewardFunction):
    ...
    def __init__(
        ...
        super().__init__(name="CountBasedExplorationReward", reward_clip=reward_clip, enabled=enabled)
...
class ConstraintPenaltyReward(BaseRewardFunction):
    ...
    def __init__(
        ...
        super().__init__(name=f"ConstraintPenaltyReward_{constraint_name}",
                        reward_clip=reward_clip, enabled=enabled)
...
class RewardValidator:
    ...
    def validate(
        ...
        try:
            ...
            if hasattr(reward_fn, "reset") and callable(reward_fn.reset):
                reward_fn.reset()
