...
public class b2Body
{
	...
	{
		var angle2: Number = b2ChazSafeTrig.safeATan2(s2.GetDirectionVector().y, s2.GetDirectionVector().x);
		var coreOffset: Number = b2ChazSafeTrig.safeTan((angle2 - angle1) * 0.5);
