...
|  #486 | — send timeout in `BonkVecEnv._send_json` mirrors `_recv_json` recovery (env closed, transport torn down; non-timeout ZMQ errors on both halves do the same)                                 |
